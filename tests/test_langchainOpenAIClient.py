...
def create_conversation_chain():
    # Initialize the custom chat model with tools support
    chat = ChatOpenAI(
...
def main():
    ...
    questions = [
        ...
        "Can you help me solve this math problem: If a train travels 120 km in 2 hours, what's its average speed?",
